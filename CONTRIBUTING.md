# Contributing to Kryten WebUI

Thank you for considering contributing to Kryten WebUI! This document provides guidelines for contributing to the project.
...
1. Clone your fork:
```bash
git clone https://github.com/YOUR_USERNAME/kryten-webui.git
cd kryten-webui
```
